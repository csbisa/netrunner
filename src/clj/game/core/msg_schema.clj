...
(def MapCosts
  [:map
   [:click {:optional true} number?]
   [:lose-click {:optional true} number?]
   [:credits {:optional true} [:tuple keyword? [:or number? [:map [:cards [:sequential [:tuple string? number?]]]]]]]
   [:trash {:optional true} [:tuple keyword? card]]
   [:forfeit {:optional true} [:tuple keyword? count-or-card-list]]
   [:gain-tag {:optional true} [:tuple keyword? number?]]
   [:tag {:optional true} [:tuple keyword? number?]]
   [:bad-pub {:optional true} [:tuple keyword? number?]]
   [:return-to-hand {:optional true} [:tuple keyword? number?]]
   [:remove-from-game {:optional true} [:tuple keyword? card]]
   [:rfg-program {:optional true} [:tuple keyword? card-list]]
   [:trash-installed {:optional true} [:tuple keyword? card-list]]
   [:hardware {:optional true} [:tuple keyword? card-list]]
   [:derez {:optional true} [:tuple keyword? card-list]]
   [:program {:optional true} [:tuple keyword? card-list]]
   [:resource {:optional true} [:tuple keyword? card-list]]
   [:connection {:optional true} [:tuple keyword? card-list]]
   [:ice {:optional true} [:tuple keyword? card-list]]
   [:trash-from-deck {:optional true} [:tuple keyword? count-or-card-list]]
   [:trash-from-hand {:optional true} [:tuple keyword? count-or-card-list]]
   [:randomly-trash-from-hand {:optional true} [:tuple keyword? count-or-card-list]]
   [:trash-entire-hand {:optional true} [:tuple keyword? count-or-card-list]]
   [:trash-hardware-from-hand {:optional true} [:tuple keyword? card-list]]
   [:trash-program-from-hand {:optional true} [:tuple keyword? card-list]]
   [:trash-resource-from-hand {:optional true} [:tuple keyword? card-list]]
   [:take-net {:optional true} [:tuple keyword? number?]]
   [:take-meat {:optional true} [:tuple keyword? number?]]
   [:take-core {:optional true} [:tuple keyword? number?]]
   [:shuffle-installed-to-stack {:optional true} [:tuple keyword? card-list]]
   [:add-installed-to-bottom-of-deck {:optional true} [:tuple keyword? card-list]]
   [:add-random-from-hand-to-bottom-of-deck {:optional true} [:tuple keyword? number?]]
   [:agenda-counter {:optional true} [:cat keyword? [:+ [:tuple card number?]]]]
   [:virus {:optional true} [:cat keyword? [:+ [:tuple card number?]]]]
   [:advancement {:optional true} [:cat keyword? [:+ [:tuple card number?]]]]
   [:power {:optional true} [:cat keyword? [:+ [:tuple card number?]]]]
   [:turn-hosted-matryoshka-facedown {:optional true} [:tuple keyword? number?]]])
