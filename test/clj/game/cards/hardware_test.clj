  ...
  (do-game
    ...
    (let [chest (get-hardware state 0)]
      ...
      (is (second-last-log-contains? state (str "Runner uses The Wizard's Chest"
                                                " to reveal Legwork, Corroder, Ice Carver, Prepaid VoicePAD, and Femme Fatale from the top of the stack."))))))
...
(deftest the-wizards-chest-single-card-selection
  (do-game
    ...
    (let [chest (get-hardware state 0)]
      ...
      (is (= "Femme Fatale" (:title (get-program state 0))) "Femme Fatale is installed")
      (is (second-last-log-contains? state (str "Runner uses The Wizard's Chest"
                                                " to reveal Legwork, Ice Carver, Prepaid VoicePAD, Femme Fatale, and Earthrise Hotel from the top of the stack."))))))
